<div class="container-fluid"
     style="background-image: url({linkS}layout/images/logo/banner_tours/banner_tours.png);
        ...
        <div class ="col-md-12 col-lg-12">
            ...
            <li>
                <div class ="col-md-4 col-lg-4" style="padding-left:0px">
                    <a href="{linkS}{category}/{product_key}.htmls" class="preview">
                        <img src="{linkS}upload/product_tours/{product_img}"
                            width="100%"
                            height="220"
                ...
                <div class ="col-md-5 col-lg-5" 
                    ...
                    <div>
                        <a class = "product_name" 
                           href="{linkS}{category}/{product_key}.htmls" 
                           style = "color: #1159bb;
