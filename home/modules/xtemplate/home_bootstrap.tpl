...
<div class = "container" style ="padding-bottom: 40px; padding-top: 40px">
    <div class = "row" style ="padding-bottom: 40px">
        <div class = "col-md-12 col-lg-12" style="text-align: center">            
            <span style="font-family:OpenSans-ExtraBold; 
                         color:#0c72bd;
                         font-size:32px;">
                LOẠI PHÒNG
            </span>
            <!--<img src="{linkS}layout/bootstrap/images/home_loai_phong.png" 
                 style = "display:block;
                          margin-left: auto;
                          margin-right: auto;
                          width: 200px;"/>-->
        ...
        <div class="product_detail">                        
            <a href="{linkS}{category}/{product_key}.htm">
                <img src="{linkS}upload/product/{product_img}" 
                    ...
                    height="245" 
                    alt="{product_name}"
                    style = "cursor: pointer; padding-right: 23px"/>
...
<!--Begin Tours-->                                  
<div class="container-fluid" style ="background-color:#eaf4f6; margin-top: -25px">                
    <div class = "container" id = "tour_container" style="padding-bottom:30px">
        <div class ="col-md-12 col-lg-12" style="padding-top: 40px; padding-bottom: 40px">
           <img src="{linkS}layout/bootstrap/images/home_tour.png" 
        ...
        <li>
            <div class="tours_detail">
                <a href="{linkS}{category}/{tours_key}.htmls">
                <div class="tours_name">                    
                    <img src="{linkS}upload/product_tours/{tours_img}" 
                        width="300" 
                        height="180" 
                        alt="{tours_name}"
                        style = "cursor: pointer; padding-right: 23px"/>
...
<div class="container-fluid" style ="background-color:white; margin-top: -25px">
    <div class = "container" id = "tour_container" style="padding-bottom:30px">
        <div class ="col-md-12 col-lg-12" style="padding-top: 40px; padding-bottom: 40px">
           <img src="{linkS}layout/bootstrap/images/home_news.png" 
                style = "margin-left: auto;
                        margin-right: auto;
                        display: block;"/>
        </div>
