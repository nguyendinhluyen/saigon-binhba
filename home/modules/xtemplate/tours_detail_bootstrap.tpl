                    ...
                    <form name='cart' action="{linkS}gio-hang/{product_key}/add" method="post">                        
                        <div style="font-family:RobotoSlabRegular;">                            
                            ...
                            <div class="main_image">
                                <img src="{linkS}upload/product_tours/{product_image}" alt="{product_name}" style="width: 600px; height: 400px"/>
                                <div class="desc">                
                                    <div class="block" >
                            ...
                            <div class="image_thumb">
                                <ul>
                                    <li style="height: 77px">
                                        <a href="{linkS}upload/product_tours/{product_image}">
                                            <img src="{linkS}upload/product_tours/{product_image}" 
                                                 alt="{product_image}"
                                                 style="width: 62px;
                                                        height: 50px;"/>
                                        </a>
                                    ...
                                    <li style="height: 77px">
                                        <a href="{linkS}upload/product_tours/{product_image_first}">
                                            <img src="{linkS}upload/product_tours/{product_image_first}" 
                                                 alt="{product_name}"
                                                 style="width: 62px; 
                                                        height: 50px;"/>
                                        </a>
                                    ...
                                    <li style="height: 77px">
                                        <a href="{linkS}upload/product_tours/{product_image_second}">
                                            <img src="{linkS}upload/product_tours/{product_image_second}" 
                                                 alt="{product_name}"
                                                 style="width: 62px; 
                                                        height: 50px;"/>
                                        </a>
                                    ...
                                    <li style="height: 77px">
                                        <a href="{linkS}upload/product_tours/{product_image_third}">
                                            <img src="{linkS}upload/product_tours/{product_image_third}" 
                                                 alt="{product_name}"
                                                 style="width: 62px; 
                                                        height: 50px;"/>
                                        </a>
                                    ...
                                    <li style="height: 76px">
                                        <a href="{linkS}upload/product_tours/{product_image_fourth}">
                                            <img src="{linkS}upload/product_tours/{product_image_fourth}" 
                                                 alt="{product_name}"
                                                 style="width: 62px; 
                                                        height: 50px;"/>
                                        </a>
                                ...
                                <div>                     
                                    ...
                                    <div id = "info_product" 
                                        ...
                                        <div style="margin-bottom:10px;
                                                    ...
                                                    color: white;">
                                             ĐỂ ĐẶT TOUR VUI LÒNG LIÊN HỆ HOTLINE
                                             <br/>
                                            <span style="clear:both; 
                                                         font-family: OpenSans-ExtraBold; 
                                                         font-size: 25px">
                                                0905 56 53 11 - 0945 46 79 68
                                            </span>
                                        </div>
    ...
    <div class ="row">
        <div class ="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:0px; margin-top: 20px; margin-bottom: 20px">            
            <div style="padding: 10px; 
                        ...
                        font-size: 20px;
                        color: white;">
                XEM CÁC TOUR HẤP DẪN KHÁC
            </div>
            <div class="product_detail_room_relation" 
                 style="width:320px; margin-left: 1px; margin-right: 3px">                        
                <a href="{linkS}{category_sub_first}/{product_key_sub_first}.htmls">
                    <img src="{linkS}upload/product_tours/{product_img_sub_first}" 
                        width="320" 
                        height="180" 
            ...
            <div class="product_detail_room_relation" 
                 style="width:320px; margin-right: 4px">                        
                <a href="{linkS}{category_sub_second}/{product_key_sub_second}.htmls">
                    <img src="{linkS}upload/product_tours/{product_img_sub_second}" 
                        width="320" 
                        height="180" 
            ...
            <div class="product_detail_room_relation" 
                 style="width:320px">
                <a href="{linkS}{category_sub_third}/{product_key_sub_third}.htmls">
                    <img src="{linkS}upload/product_tours/{product_img_sub_third}" 
                        width="320" 
                        height="180" 
