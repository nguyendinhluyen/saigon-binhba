...
<script type="text/javascript">
    ...
    function lookup(inputString) {
        if(inputString.length === 0) {
            ...
            $.post("../include/autoSugAjaxTours.php", {queryString: ""+inputString+""}, function(data){
                if(data.length >0) {
                    $('#suggestions').show();
...
<form method='POST' enctype='multipart/form-data' id = "frm" name = "frm">
    ...
    <div style = "float:left">
        ...
        <div class = "title" style = 'width:851px'>
            ...
            <div class = "con_title" style = "width:180px;">
                <a href = './?show=product_tours&order=name&p={p}' style="text-decoration:underline">{productname} (a->z)</a>
                <span>&nbsp&nbsp-&nbsp </span>
                <span>
                    <a href = './?show=product_tours&order=name_desc&p={p}'style = "text-decoration:underline">(z->a)</a>
                </span>
            </div>
            ...
            <div class = "con_title" style = "width:60px;">
                <a href = './?show=product_tours&order=status&p={p}'style='text-decoration:underline'>{lag_status}</a>
            </div>
            <div class = "con_title" style = "width:110px;border:0px;">
                <a href = './?show=product_tours&order=dateadd&p={p}' style="text-decoration:underline">Ngày (cũ)</a>
                <span>&nbsp&nbsp-&nbsp </span>
                <span>
                    <a href = './?show=product_tours&order=dateadd_desc&p={p}'style = "text-decoration:underline">(mới)</a>
                </span>
            </div>                 
            <div class = "con_title" style = "width:auto;text-decoration:underline">
                <a href = './?show=product_tours&order=price_desc&p={p}'>Giá Giảm </a>
            </div>
            <div class = "con_title" style = "width:auto;text-decoration:none">&nbsp-&nbsp </div>
            <div class = "con_title" style = "width:auto;text-decoration:underline">
                <a href = './?show=product_tours&order=price_asc&p={p}'> Giá Tăng</a>
            </div>                 
        </div>                                                            
        <!--End header-->
        <div>
            ...
            <div class = "con_list_con" style = "width:50px;background-color:{color};height:50px;">
                <a href="?show=product_tours&action=del&id={id}&p={p}&order={oderby}" onclick="return confirm('{del_confirm} ?');">{lag_delete}</a>
            </div>
            <div class = "con_list_con" style = "width:50px;background-color:{color};height:50px;">
                <a href="?show=OptProduct_tours&id={id}&p={p}&order={oderby}">{lag_edit}</a>
            </div>
    ...
    <input class = "button" type = "button" value = "Thêm mới" onclick="window.location='./?show=OptProduct_tours&order={oderby}'">
</form>
